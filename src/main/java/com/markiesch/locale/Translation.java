...
public enum Translation {
    ...
    MENU_PLAYERS_CATEGORIES_BUTTON_TITLE("menu.players.categories_button.title"),
    MENU_PLAYERS_CATEGORIES_BUTTON_LORE("menu.players.categories_button.lore"),
    ...
    MENU_CATEGORY_INSERT_MESSAGE_TITLE("menu.category.insert_message.title"),
    MENU_CATEGORY_INSERT_MESSAGE_SUBTITLE("menu.category.insert_message.subtitle"),
    MENU_CATEGORY_INSERT_MESSAGE_COPY("menu.category.insert_message.copy"),
